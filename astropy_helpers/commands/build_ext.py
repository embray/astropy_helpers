...
def generate_build_ext_command(packagename, release):
    ...
    class build_ext(SetuptoolsBuildExt, object):
        ...
        description = (
                SetuptoolsBuildExt.description +
                "\n\nThis command does not support Cython-specific build "
                "options.  To build with Cython-specific options use the "
                "'build_ext_cython' command.")
